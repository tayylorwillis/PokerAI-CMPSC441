      ...
      <main>
        ...
        <div className="page">
          <div className="back-stacks">
           <ChipStack count={10} size={30} color="white" borderColor="blue" borderWidth={2} />
           <ChipStack count={10} size={30} color="blue" borderColor="white" borderWidth={2} />
           <ChipStack count={10} size={30} color="green" borderColor="white" borderWidth={2} />
           <ChipStack count={10} size={30} color="black" borderColor="gray" borderWidth={2} />
           <ChipStack count={10} size={30} color="purple" borderColor="white" borderWidth={2} />
          </div> 

      {/* front-middle overlay: red & gold stacks placed here so they appear in front and centered */}
          <div className="front-stacks">
           <ChipStack count={7} size={30} color="red" borderColor="white" borderWidth={2} stackZ={2000} />
           <ChipStack count={7} size={30} color= "gold" borderColor="white" borderWidth={2} stackZ={2000} />
          </div>
        </div>
